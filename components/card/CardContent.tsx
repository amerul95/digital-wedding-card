...
export function CardContent({
  ...
  return (
    <div className="absolute inset-0 overflow-y-auto scrollbar-hide pb-24 scroll-smooth" style={{ WebkitOverflowScrolling: 'touch' }}>
      {/* Section 1 */}
      <section id="card-sec-1" className="min-h-full flex flex-col justify-center items-center text-center px-8 py-8">
      ...
      {/* Section 2 */}
      <section id="card-sec-2" className="min-h-full flex flex-col justify-center items-center text-center px-8 py-8">
      ...
      {/* Section 3 */}
      <section id="card-sec-3" className="min-h-full flex flex-col justify-center items-center text-center px-8 py-8">
      ...
      {/* Section 4 */}
      <section id="card-sec-4" className="min-h-full flex flex-col justify-center items-center text-center px-8 py-8">
